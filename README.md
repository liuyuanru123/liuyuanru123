...
| 期間 | 所属 |
|---|---|
| **2023.10 – 2025.09** | 修士課程修了, 九州大学大学院 生物資源環境科学府 数理モデリング学研究室<br />*指導教員: Ton Viet Ta 准教授* |
...
（自身の TOEIC 受験経験を活かす：805 [2020] / 770 [2025]。）

### 🌿 Git / GitHub によるリポジトリ運用
**継続的　／　研究室・個人プロジェクト**

研究室の *RainNet-MT* および関連プロジェクトの GitHub リポジトリを継続的に運用。
ブランチ管理・コミット運用・コンフリクト解決・複数アカウント環境（個人 / 研究用）の構築まで、
Git ベースの開発フローを一貫して担当。
